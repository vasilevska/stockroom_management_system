...
Specifies which tests will be run. Value "authentication" runs test which grade authentication endpoints. Following parameters are required:
    ...
    Example:
    python main.py --type authentication --authentication-address http://127.0.0.1:5001 --jwt-secret JWTSecretDevKey --roles-field role --administrator-role admin --customer-role customer --warehouse-role manager
...
1) Value "level0" is used for running tests which grade endpoints that update (warehouse container) and search (customer container) products. Following parameters are supported:
    ...
    or
    python main.py --type level0 --with-authentication --authentication-address http://127.0.0.1:5001 --customer-address http://127.0.0.1:5000 --warehouse-address http://127.0.0.1:5002
...
2) Value "level1" is used for running tests which grade endpoints that create orders (complete and pending) and retrieve their status. Following parameters are supported:
    ...
    or
    python main.py --type level1 --with-authentication --authentication-address http://127.0.0.1:5001 --customer-address http://127.0.0.1:5000 --warehouse-address http://127.0.0.1:5002
...
3) Value "level2" is used for running tests which grade endpoints that update the status of certain products and orders (FIFO). Following parameters are supported:
    ...
    or
    python main.py --type level2 --with-authentication --authentication-address http://127.0.0.1:5001 --customer-address http://127.0.0.1:5000 --warehouse-address http://127.0.0.1:5002
...
4) Value "level3" is used for running tests which grade endpoints that provide administrators with product and category selling statistics. Following parameters are supported:
    ...
    python main.py --type level3 --customer-address http://127.0.0.1:5000 --warehouse-address http://127.0.0.1:5002 --administrator-address http://127.0.0.1:5003
    or
    python main.py --type level3 --with-authentication --authentication-address http://127.0.0.1:5001 --customer-address http://127.0.0.1:5000 --warehouse-address http://127.0.0.1:5002 --administrator-address http://127.0.0.1:5003
...
Value "all" is used for running all tests. Following parameters are required:
    ...
    Example:
    python main.py --type all --authentication-address http://127.0.0.1:5001 --jwt-secret JWTSecretDevKey --roles-field role --administrator-role admin --customer-role customer --warehouse-role manager --customer-address http://127.0.0.1:5000 --warehouse-address http://127.0.0.1:5002 --administrator-address http://127.0.0.1:5003 --with-authentication
